...
\end{equation}
%
The charateristic function is the Heaviside function as $\chi_p = 1  \text{  if  } \pmb{x} \in \Omega_p, \text{otherwise 0} $ (see Figure \ref{fig:GIMP}). The time discretization are solved using the following steps:
%
%
