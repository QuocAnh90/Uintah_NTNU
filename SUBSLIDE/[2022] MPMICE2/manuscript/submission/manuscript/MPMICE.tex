...
%
%
where $\Delta W_{si}^n = \pmb{\sigma}^\prime : \frac{D_s( \pmb{\epsilon}_s^p)}{Dt} $ is the mechanical work rate computed from the constitutive model with $\pmb{\epsilon}_s^p$ is the plastic strain, $ \Delta W_{fric,i}^n$ is the work rate compted from the contact law due to the frictional sliding between solid materials. The heat flux is $\pmb{q}_s = \overline{\rho}_s \beta_s \nabla T_s$ with $\beta_s$ being the thermal conductivity of the solid materials.
...
\bibitem{Stewart1974}Stewart, R. The air-sea momentum exchange. {\em Boundary-Layer Meteorology}. \textbf{6}, 151-167 (1974,3), https://doi.org/10.1007/bf00232481
\bibitem{Ali}Amiri, S., Taheri, E. \& Lavasan, A. A hybrid finite element model for non-isothermal two-phase flow in deformable porous media. {\em Computers And Geotechnics}. \textbf{135} pp. 104199 (2021,7), https://doi.org/10.1016/j.compgeo.2021.104199
\bibitem{GIMP}E. M. Kober, S. The Generalized Interpolation Material Point Method. {\em Computer Modeling In Engineering And Sciences}. \textbf{5} pp. 477-496 (2004), https://doi.org/10.3970/cmes.2004.005.477
\bibitem{MPMcontact}Bardenhagen, S., Guilkey, J., Roessig, K., Brackbill, J., Witzel, W. \& J.C.Foster An Improved Contact Algorithm for the Material Point Method and Application to Stress Propagation in Granular Material. {\em CMES-Computer Modeling In Engineering And Sciences}. \textbf{2} pp. 509-522 (2001)
\bibitem{Baumgarten2021}Baumgarten, A., Couchman, B. \& Kamrin, K. A coupled finite volume and material point method for two-phase simulation of liquid–sediment and gas–sediment flows. {\em Computer Methods In Applied Mechanics And Engineering}. \textbf{384} pp. 113940 (2021,10), https://doi.org/10.1016/j.cma.2021.113940
\bibitem{Bandara2015}Bandara, S. \& Soga, K. Coupling of soil deformation and pore fluid flow using material point method. {\em Computers And Geotechnics}. \textbf{63} pp. 199-214 (2015,1), https://doi.org/10.1016/j.compgeo.2014.09.009
\bibitem{Tampubolon2017}Tampubolon, A., Gast, T., Klár, G., Fu, C., Teran, J., Jiang, C. \& Museth, K. Multi-species simulation of porous sand and water mixtures. {\em ACM Transactions On Graphics}. \textbf{36}, 1-11 (2017,7), https://doi.org/10.1145/3072959.3073651
\bibitem{Baumgarten2019}Baumgarten, A. \& Kamrin, K. A general constitutive model for dense, fine-particle suspensions validated in many geometries. {\em Proceedings Of The National Academy Of Sciences}. \textbf{116}, 20828-20836 (2019,9), https://doi.org/10.1073/pnas.1908065116
\bibitem{Zheng2021}Zheng, X., Pisanò, F., Vardon, P. \& Hicks, M. An explicit stabilised material point method for coupled hydromechanical problems in two-phase porous media. {\em Computers And Geotechnics}. \textbf{135} pp. 104112 (2021,7), https://doi.org/10.1016/j.compgeo.2021.104112
\bibitem{Chen2017}Chen, J., Hillman, M. \& Chi, S. Meshfree Methods: Progress Made after 20 Years. {\em Journal Of Engineering Mechanics}. \textbf{143} (2017,4), https://doi.org/10.1061/(asce)em.1943-7889.0001176
\bibitem{CPLS}Tran, Q., Sołowski, W., Berzins, M. \& Guilkey, J. A convected particle least square interpolation material point method. {\em International Journal For Numerical Methods In Engineering}. \textbf{121}, 1068-1100 (2019,11), https://doi.org/10.1002/nme.6257
\bibitem{nullspace}Tran, Q. \& Sołowski, W. Temporal and null-space filter for the material point method. {\em International Journal For Numerical Methods In Engineering}. \textbf{120}, 328-360 (2019,6), https://doi.org/10.1002/nme.6138
\bibitem{Tran2019}Tran, Q. \& Sołowski, W. Generalized Interpolation Material Point Method modelling of large deformation problems including strain-rate effects – Application to penetration and progressive failure problems. {\em Computers And Geotechnics}. \textbf{106} pp. 249-265 (2019,2), https://doi.org/10.1016/j.compgeo.2018.10.020
\bibitem{Capone2010}Capone, T., Panizzo, A. \& Monaghan, J. SPH modelling of water waves generated by submarine landslides. {\em Journal Of Hydraulic Research}. \textbf{48}, 80-84 (2010,1), https://doi.org/10.1080/00221686.2010.9641248
\bibitem{Zhang2019}Zhang, X., Oñate, E., Torres, S., Bleyer, J. \& Krabbenhoft, K. A unified Lagrangian formulation for solid and fluid dynamics and its possibility for modelling submarine landslides and their consequences. {\em Computer Methods In Applied Mechanics And Engineering}. \textbf{343} pp. 314-338 (2019,1), https://doi.org/10.1016/j.cma.2018.07.043
\bibitem{Dey2016}Dey, R., Hawlader, B., Phillips, R. \& Soga, K. Numerical modelling of submarine landslides with sensitive clay layers. {\em Géotechnique}. \textbf{66}, 454-468 (2016,6), https://doi.org/10.1680/jgeot.15.p.111
\bibitem{Kamrin}Baumgarten, A. \& Kamrin, K. A general fluid–sediment mixture model and constitutive theory validated in many flow regimes. {\em Journal Of Fluid Mechanics}. \textbf{861} pp. 721-764 (2019)
\bibitem{DRUMHELLER}Drumheller, D. On theories for reacting immiscible mixtures. {\em International Journal Of Engineering Science}. \textbf{38}, 347 - 382 (2000), http://www.sciencedirect.com/science/article/pii/S0020722599000476
\bibitem{CFD1}Yuk, D., Yim, S. \& Liu, P. Numerical modeling of submarine mass-movement generated waves using RANS model. {\em Computers And Geosciences}. \textbf{32}, 927-935 (2006,8), https://doi.org/10.1016/j.cageo.2005.10.028
\bibitem{CFD2}Glimsdal, S., L'Heureux, J., Harbitz, C. \& Løvholt, F. The 29th January 2014 submarine landslide at Statland, Norway—landslide dynamics, tsunami generation, and run-up. {\em Landslides}. \textbf{13}, 1435-1444 (2016,9), https://doi.org/10.1007/s10346-016-0758-7
\bibitem{CFD3}Abadie, S., Morichon, D., Grilli, S. \& Glockner, S. Numerical simulation of waves generated by landslides using a multiple-fluid Navier–Stokes model. {\em Coastal Engineering}. \textbf{57}, 779-794 (2010,9), https://doi.org/10.1016/j.coastaleng.2010.03.003
\bibitem{CFD4}Rauter, M., Viroulet, S., Gylfadóttir, S., Fellin, W. \& Løvholt, F. Granular porous landslide tsunami modelling – the 2014 Lake Askja flank collapse. {\em Nature Communications}. \textbf{13} (2022,2), https://doi.org/10.1038/s41467-022-28296-7
\bibitem{Rzadkiewicz}Mariotti;, S. \& Heinrich, P. Numerical Simulation of Submarine Landslides and Their Hydraulic Effects. {\em Journal Of Waterway, Port, Coastal, And Ocean Engineering}. \textbf{123} (1997)
\bibitem{Drag}R. Beetstra, J. Drag force of intermediate Reynolds number flow past mono- and bidisperse arrays of spheres. {\em Fluid Mechanics And Transport Phenomena}. \textbf{53}, 489 - 501 (2007)
\bibitem{MPMICE}Guilkey, J., Harman, T. \& Banerjee, B. An Eulerian–Lagrangian approach for simulating explosions of energetic devices. {\em Computers And Structures}. \textbf{85}, 660 - 674 (2007), http://www.sciencedirect.com/science/article/pii/S0045794907000429
\bibitem{ICE}Kashiwa, B., Padial, N., Rauenzahn, R. \& VanderHeyden, W. A Cell-Centered ICE Method for Multiphase Flow Simulations. (Los Alamos National Laboratory,1994)
\bibitem{Kashiwa}Kashiwa, B. A multifield Model and Method for fluid-structure interaction dynamics. (Los Alamos National Laboratory,2001)
\bibitem{Hassanizadeh}Hassanizadeh, S. Derivation of basic equations of mass transport in porous media, Part1: Macroscopic balance laws. {\em Advances In Water Resources}. \textbf{9} pp. 196-206 (1986)
\bibitem{water}Thomsen, J. \& Hartka, T. Strange Carnot Cycles; Thermodynamics of a System with a Density Exremum. {\em American JOurnal Of Physics}. \textbf{30} pp. 26-33 (1962)
\bibitem{permeability}Yazdchi, K. \& Luding, S. Towards unified drag laws for inertial flow through fibrous materials. {\em Chemical Engineering Journal}. \textbf{207-208} pp. 35-48 (2012)
