...
%
%
where $\Delta W_{si}^n = \pmb{\sigma}^\prime : \Delta \pmb{\epsilon}_s$ is the mechanical work rate computed from the constitutive model with $\pmb{\epsilon}_s$ is the total strain. The nodal internal temperature is calculated by
\begin{equation}
...
%
%
On the right hand side, the terms include the rate of the mechanical work $\Delta W_{s} = \pmb{\sigma}^\prime : \Delta \pmb{\epsilon}_s$ computed from the constitutive model with $\pmb{\epsilon}_s$ is the total strain, thermal transport and energy exchange between solid and fluid respectively. The heat flux is $\pmb{q}_s = \overline{\rho}_s \beta_s \nabla T_s$ with $\beta_s$ being the thermal conductivity of the solid materials
%
%
