...
%
%
On the other hand, the draf force can be calculated as:
%
%
\begin{equation}
...
%
%
On the right hand side, the terms include the mechanical work $\Delta W_{s} = \pmb{\sigma}^\prime : \Delta \pmb{\epsilon}^p_s$ computed from the constitutive model with $\pmb{\epsilon}^p_s$ is the plastic strain, thermal transport and energy exchange between solid and fluid respectively. The heat flux is $\pmb{q}_s = \overline{\rho}_s \beta_s \nabla T_s$ with $\beta_s$ being the thermal conductivity of the solid materials
%
%
