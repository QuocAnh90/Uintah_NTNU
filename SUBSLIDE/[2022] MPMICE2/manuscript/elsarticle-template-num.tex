...
%
%
To simulate the interaction between sediment (soil), seawater (fluid) and offshore structure (solid), the work presented here describes a numerical approach for simulation of soil-fluid-structure interaction involving large deformation namely MPMICE. MPMICE is the coupling of the Material Point Method (MPM) and Implicit Continuous Eulerian (ICE). MPM allows the
