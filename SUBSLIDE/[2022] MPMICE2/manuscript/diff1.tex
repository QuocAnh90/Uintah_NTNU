...
%DIF ADD MPMICE_v5.tex   Thu May 18 16:09:24 2023
...
\end {equation}
%
Solving the mass balance equation \DIFaddbegin \DIFadd{of the solid phase }\DIFaddend leads to:
%
%
\begin{equation}
  \frac{D_s n}{Dt} = \phi_s \nabla \cdot \pmb{U}_s  
...
\begin{equation}
\begin{gathered}
   f =  \DIFaddbegin \DIFadd{-}\DIFaddend \sigma_1^{\prime} \DIFdelbegin \DIFdel{-  }\DIFdelend \DIFaddbegin \DIFadd{+  }\DIFaddend \sigma_3^{\prime} \DIFdelbegin \DIFdel{-2c}\DIFdelend \DIFaddbegin \DIFadd{+2c}\DIFaddend ^{\prime} cos(\phi^{\prime}) \DIFdelbegin \DIFdel{- }\DIFdelend \DIFaddbegin \DIFadd{+ }\DIFaddend (\sigma_1^{\prime} +  \sigma_3^{\prime})sin(\phi^{\prime})\\
   g =  \DIFaddbegin \DIFadd{-}\DIFaddend \sigma_1^{\prime} \DIFdelbegin \DIFdel{-  }\DIFdelend \DIFaddbegin \DIFadd{+  }\DIFaddend \sigma_3^{\prime} \DIFdelbegin \DIFdel{-2c}\DIFdelend \DIFaddbegin \DIFadd{+2c}\DIFaddend ^{\prime} cos(\psi^{\prime}) \DIFdelbegin \DIFdel{- }\DIFdelend \DIFaddbegin \DIFadd{+ }\DIFaddend (\sigma_1^{\prime} +  \sigma_3^{\prime})sin(\psi^{\prime})
\end {gathered}
\end {equation}
%
%
\DIFdelbegin \DIFdel{where the }\DIFdelend \DIFaddbegin \DIFadd{In the equations, }\DIFaddend $c^{\prime}$, $\phi^{\prime}$\DIFaddbegin \DIFadd{, }\DIFaddend and $\psi^{\prime}$ \DIFdelbegin \DIFdel{are cohesionand friction angle}\DIFdelend \DIFaddbegin \DIFadd{represent the cohesion, friction angle, }\DIFaddend and dilation angle\DIFaddbegin \DIFadd{, respectively}\DIFaddend . $\sigma_1^{\prime}$ and $\sigma_3^{\prime}$ \DIFdelbegin \DIFdel{are }\DIFdelend \DIFaddbegin \DIFadd{denote the }\DIFaddend maximum and minimum principal \DIFdelbegin \DIFdel{stress}\DIFdelend \DIFaddbegin \DIFadd{stresses, with the condition $\sigma_1^{\prime}<\sigma_3^{\prime}<0$. It is important to note that in our assumptions, stress is considered positive during extension, which means the signs of the stresses in these equations are opposite to those in standard Soil Mechanic's textbooks}\DIFaddend .
%_______________________________
...
%
%
The nodal external forces $f_{si}^{ext,n}$ and \DIFdelbegin \DIFdel{extra momentum from contact forces }\DIFdelend \DIFaddbegin \DIFadd{the frictional forces from soil-structure interaction $f_{fric,si}^{n}$ from contact between materials }\DIFaddend are computed here.\DIFdelbegin \DIFdel{The nodal velocity and nodal temperature are applied boundary conditions.}\DIFdelend \\
...
%
%
Then the boundary condition and contact forces \DIFaddbegin \DIFadd{$f_{si}^{fric}$ }\DIFaddend are applied to the nodal velocity\DIFdelbegin \DIFdel{and the acceleration is modified by}\DIFdelend \DIFaddbegin \DIFadd{, and then accelerations are modified by:
}\DIFaddend %
%
\begin{equation}
...
\end {subfigure}\hfill    
\begin{subfigure}[d]{0.5\linewidth}
\DIFdelbegin %DIFDELCMD < \includegraphics[width=\linewidth]{vel.jpg}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \includegraphics[width=\linewidth]{vel1.jpg}
\DIFaddend \caption{velocity}
